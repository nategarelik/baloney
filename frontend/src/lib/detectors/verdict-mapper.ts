// Verdict mapping logic for text and image detection results.
// Reads thresholds and formula coefficients from DETECTION_CONFIG.

import type { Verdict } from "../types";
import { DETECTION_CONFIG } from "../detection-config";
import { precise } from "./detection-utils";
